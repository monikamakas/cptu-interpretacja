...
def detect_layers(profile, min_thickness=0.30, smooth_window=15):
    ...
    for s in segs:
        ...
        gated_cols = {
            ...
            "OCR (SHANSEP) [-]": is_fine, "sigma_p (SHANSEP) [kPa]": is_fine,
            "sigma_p (Robertson) [kPa]": is_fine, "sigma_p (Kulhawy-Mayne) [kPa]": is_fine,
            "Ko [-]": is_fine,
        }
        for col in ["qt [MPa]", "Rf [%]", "Ic [-]", "gamma [kN/m3]", "N60 [-]",
                    ...
                    "OCR (SHANSEP) [-]", "sigma_p (Robertson) [kPa]", "sigma_p (Kulhawy-Mayne) [kPa]",
                    "sigma_p (SHANSEP) [kPa]", "K0 (Jaky, NC) [-]", "Ko [-]",
                    "k [m/s]"]:
